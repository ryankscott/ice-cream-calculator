...
export const DEFAULT_COLUMN_VISIBILITY: Record<string, boolean> = {
	...
	totalCarbPer100g: true,
	totalSugarsPer100g: true,
	sodiumMgPer100g: true,
	waterPer100g: true,
	totalSolidsPer100g: true,
	otherSolidsPer100g: true,
	msnfPer100g: true,
	sucrosePer100g: true,
	fructosePer100g: true,
	glucosePer100g: true,
	dextrosePer100g: true,
	alcoholPer100g: true,
	otherSugarsPer100g: true,
	dryCocoaSolidsPer100g: true,
	cocoaButterPer100g: true,
	packageSizeInGrams: true,
	costPerPackInCentsExGst: true,
	percentOfUsefulProduct: true,
	hf: true,
	foodCompositionId: true,
	createdAt: true,
	lastModifiedAt: true,
	id: true,
};
