...
import { createDatabase, runMigrations } from './database/connection-functional';
import { createIngredientsRoutes, createSuppliersRoutes } from './routes/ingredients.routes';
import { createIngredientsService, createSuppliersService } from './services/ingredients-functional.service';
import { seedFunctionalDatabase } from './database/seeds/ingredients-functional.seed';
